...
### 1. Nanopore Analysis
* [Epi2me setup](notebooks/Nanopore_Analysis/DSC_Workshop2026_Mod_2_Epi2meSetup.ipynb)  
* [Epi2me bacterial-genomes workflow](notebooks/Nanopore_Analysis/DSC_Workshop2026_Mod_2_wf-bacterial-genomes.ipynb)  
* [Epi2me metagenomics workflow](notebooks/Nanopore_Analysis/DSC_Workshop2026_Mod_2_wf-metagenomics.ipynb)  
* [Walkthrough of the get_all_stats.sh script](notebooks/Nanopore_Analysis/DSC_Workshop2026_Mod_4_get_stats.ipynb) 
* [Walkthrough of the install_bioinfo_tools.sh script](notebooks/Nanopore_Analysis/DSC_Workshop2026_Mod_4_install_bioinfo_tools.ipynb)
* [Adaptive sampling analysis pipeline](notebooks/Nanopore_Analysis/DSC_Workshop2026_Mod_4_process_AS.ipynb)
...
* [Instructions for Setting up Sequencing Runs using MinKnow Software](handouts/Protocols/MinKnow_Run_Setup.pdf)
* [Interpretation of Run Results (video)](handouts/)
